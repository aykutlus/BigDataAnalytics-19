...
import org.uma.mbd.mdHospitalV1L.mdhospitalv1l.*;
...
public class Main {
    ...
    public static void main(String [] args) {
        Doctor med1 = new Doctor("22626262", "Juan", "Garcia Lopez", 34, Genero.HOMBRE,
                Categoria.ADJUNTO, true, 12);
        Doctor med2 = new Doctor("73737373", "Pedro", "Marin Perez", 33, Genero.HOMBRE,
                Categoria.INTERINO, true, 12);
        Doctor med3 = new Doctor("99487474", "Maria", "Velez Lopez", 39, Genero.MUJER,
                Categoria.ADJUNTO, true, 12);
        Doctor med4 = new Doctor("25252525", "Luisa", "Morilla Antera", 50, Genero.MUJER,
                Categoria.RESIDENTE, false, 12);
        Doctor med5 = new Doctor("88477444", "Ramon", "Gullon Mande", 46, Genero.HOMBRE,
                Categoria.RESIDENTE, false, 12);
        Doctor med6 = new Doctor("53536733", "Andres", "Robles Marea", 47, Genero.HOMBRE,
                Categoria.RESIDENTE, true, 12);
        Doctor med7 = new Doctor("77464564", "Ana", "Peralta Monte", 45, Genero.MUJER,
                Categoria.ADJUNTO, false, 12);
        Doctor med8 = new Doctor("61261523", "Ramon", "Linde Masa", 34, Genero.HOMBRE,
                Categoria.INTERINO, true, 12);
        Doctor med9 = new Doctor("99474643", "Joaquin", "Perez Valdes", 59, Genero.HOMBRE,
                Categoria.RESIDENTE, false, 12);
        ...
        Doctor me = dep3.getDoctor("99474643");
        if (me == null) {
